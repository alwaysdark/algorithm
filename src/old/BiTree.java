...
//      }
    ...
    public static void main(String[] args) {
        ...
        aBiTree.root.lchild.lchild=new BiTNode<String>("D");
        aBiTree.root.lchild.rchild=new BiTNode<String>("F");
        aBiTree.root.lchild.rchild.lchild = new BiTNode<>("E");
        aBiTree.root.rchild.lchild=new BiTNode<>("G");
        aBiTree.root.rchild.rchild=new BiTNode<>("I");
        aBiTree.root.rchild.lchild.rchild=new BiTNode<>("H");
